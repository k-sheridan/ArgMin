...
// Profiling support for Tangent (optional)
// This is a lightweight profiling macro that can be enabled with TANGENT_ENABLE_PROFILING

#ifdef TANGENT_ENABLE_PROFILING
  #include <chrono>
  #include <string>
  ...
  #define PROFILE(sectionName) Tangent::Profiler __tangent_profiler_(sectionName);
#else
